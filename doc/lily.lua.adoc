...
expresión regular en formato PCRE `[a-z0-9_]+`. Además, si el identificador
tiene un caracter asterisco al inicio, entonces el parámetro solo coincidirá
con el tipo si es un símbolo de desplazamiento.
