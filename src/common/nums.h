 ...
 * @param buf Array donde escribir los bytes
 * @param val Valor primitivo
 * @param tam Número de bytes del valor: 1, 2, 4 u 8
 * @param signo El rango de valores admitidos según su signo: 0 para un tipo positivo, 1 para un tipo negativo, 2 para cubrir todo el rango posible para el tamaño
 ...
 * @param val Valor resultante
 * @param bytes Array desde donde leer los bytes
 * @param tam Número de bytes del valor: 1, 2, 4 u 8
 * @param signo El rango de valores admitidos según su signo: 0 para un tipo positivo, 1 para un tipo negativo, 2 para cubrir t
 * @param endianness Endianness de la representación: \c true para little-endian, \c false para big-endian
 * @return Código de operación resultante
 */
